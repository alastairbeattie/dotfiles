...
hi clear
"set background=dark
let g:colors_name="alastair"

"hi VertSplit ctermfg=233 ctermbg=235
"set fillchars+=vert:\ 
"hi StatusLine ctermfg=234 ctermbg=Black
"hi StatusLineNC ctermfg=233 ctermbg=DarkGreen
"hi TabLineFill ctermfg=234 ctermbg=DarkGreen 
"hi TabLine ctermfg=Blue ctermbg=236
"hi TabLineSel ctermfg=249 ctermbg=Black
"hi LineNr ctermfg=240 ctermbg=233
"hi pythonStatement cterm=NONE guifg=#886655
"hi String ctermfg=173
"hi PreProc ctermfg=133
"hi pythonStatement ctermfg=25
"hi Function ctermfg=186
"hi Folded ctermfg=237 ctermbg=232
"hi Search ctermfg=154 ctermbg=22
"Terminal Colors:  {{{
...
highlight Comment ctermfg=0 guifg=#509020 cterm=italic gui=italic
...
highlight Function ctermfg=3 guifg=#3a9684 cterm=bold gui=NONE
...
highlight Normal ctermfg=7 guifg=#d4d4d4 ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
highlight Normal ctermfg=7 guifg=#d4d4d4 ctermbg=NONE guibg=NONE cterm=NONE gui=NONE
highlight NormalNC ctermbg=0 guibg=NONE cterm=NONE gui=NONE
...
highlight EndOfBuffer ctermfg=0 guifg=#505050 ctermbg=0 guibg=NONE cterm=NONE gui=NONE
...
highlight link pythonStrFormat dentifier
...
highlight vimsCommand ctermfg=6 guifg=#9cdcfe cterm=NONE gui=NONE
